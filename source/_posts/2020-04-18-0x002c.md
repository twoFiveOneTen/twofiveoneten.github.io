...
## 运行并测试
> 首先内网电脑上应该先建立一个网站，关于如何在windows系统上使用Nginx和PHP建立网站，请看这一篇笔记：[Windows配置Nginx + PHP](https://note.zkk.me/0x002b.html "Windows配置Nginx + PHP")。
...
如果你感觉带着端口访问很不舒服，那你可以看一下这篇文章 [Nginx反代理ngrok,实现80和443端口访问](https://note.zkk.me/0x002d.html "Nginx反代理ngrok,实现80和443端口访问")
