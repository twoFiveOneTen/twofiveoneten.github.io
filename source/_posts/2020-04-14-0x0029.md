...
categories: ["Linux"]
tags: []
permalink: /0x0029.html
---
之前有记录过一篇利用Fail2ban防止暴力破解的（[Fail2ban配合FirewallD防止SSH暴力破解](https://note.zkk.me/0x0009.html "Fail2ban配合FirewallD防止SSH暴力破解")），但是现在感觉使用起来有点麻烦（也不知道为什么我现在这么懒），不如改掉SSH端口，比较简单。<!-- more -->
