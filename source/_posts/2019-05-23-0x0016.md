...
**下载地址**：[下载](https://note.zkk.me/img/0016/assets/AntiSpam.zip "AntiSpam")

## EditorMD
EditorMD是一款Markdown编辑器，很好用。

**下载地址**：[下载](https://note.zkk.me/img/0016/assets/EditorMD.zip "EditorMD")

## CodeStyle
CodeStyle是Highlight.js代码高亮效果渲染插件，支持多种风格。

**下载地址**：[下载](https://note.zkk.me/img/0016/assets/CodeStyle.zip "CodeStyle")

## CommentToMail
CommentToMail 是一个邮件通知插件，当网站上有新评论，或者评论被回复时，都会发送邮件进行通知。详细配置方法请看本站文章 [typecho邮件通知插件CommentToMail](https://note.zkk.me/0x000e.html "typecho邮件通知插件CommentToMail")

**下载地址**：[下载](https://note.zkk.me/img/0016/assets/CommentToMail.zip "CommentToMail")

## Sticky
Sticky 是一个文章和页面置顶的插件。

**下载地址**：[下载](https://note.zkk.me/img/0016/assets/Sticky.zip "Sticky")
...
**下载地址**：[下载](https://note.zkk.me/img/0016/assets/SlimBox2.zip "SlimBox2")

## Sitemap
Sitemap是一个站点地图生成插件，启用后直接访问`你的域名/siemap.xml`就是你的站点地图

**下载地址**：[下载](https://note.zkk.me/img/0016/assets/Sitemap.zip "Sitemap")

## Access
Access是一个统计网站访客信息的插件。可以提供网站访客记录。获取访客信息，生成统计图表。<a href="https://github.com/kokororin/typecho-plugin-Access">Github库</a>
下载地址：[下载](https://note.zkk.me/img/0016/assets/Access.zip "Access")
