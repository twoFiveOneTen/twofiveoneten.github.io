...
### 说明
1. PHP版本至少 7.1
1. 如果使用Mysql数据库，则要激活 `InnoDB`引擎（关于如何查看是否激活，以及如何把`InnoDB`设为默认引擎，可以参考本站文章 [MySQL设置 InnoDB 为默认引擎](https://note.zkk.me/0x0015.html "MySQL设置 InnoDB 为默认引擎"))
